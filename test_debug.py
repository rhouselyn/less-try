...
def main():
    # 测试两个文本
    text1 = "AI models generate responses, and outputs based on complex ."
    text2 = "AI models generate responses. and outputs based on complex ."
    
    print("测试文本1:")
    result1 = test_process_text(text1)
    print(f"文本1处理结果: {'成功' if result1 else '失败'}")
    print("\n" + "="*50 + "\n")
    
    print("测试文本2:")
    result2 = test_process_text(text2)
    print(f"文本2处理结果: {'成功' if result2 else '失败'}")
