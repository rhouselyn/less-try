...
class TextProcessor:
    ...
    async def process_translation(self, text: str, source_lang: str, target_lang: str, llm, context_sentences: dict = None):
        result = await llm.process_text_with_dictionary(text, source_lang, target_lang, context_sentences)
