...
class TextProcessor:
    ...
    async def process_translation(self, text: str, source_lang: str, target_lang: str, llm_client, context_sentences: dict = None):
        result = await llm_client.process_text_with_dictionary(text, source_lang, target_lang, context_sentences)
