...
from llm_api import get_settings as get_llm_settings_raw, save_configs, set_active_index, get_lang_name, call_llm_with_rotation
...
async def _do_translate_ui(lang_code: str):
    ...
    try:
        result = await call_llm_with_rotation(messages, temperature=0, max_tokens=4096)
