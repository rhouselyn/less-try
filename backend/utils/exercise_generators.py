...
from utils.state import llm_client, text_processor, storage, processing_status, word_gen_state
    ...
    try:
        ...
        async def process_single_sentence(idx, sentence):
            ...
            if missing_words:
                ...
                remaining_entries = await llm_client.process_remaining_words(
...
async def generate_title(text: str, source_lang: str) -> str:
    ...
    try:
        ...
        result = await llm_client.call_llm(messages, temperature=0.3)
