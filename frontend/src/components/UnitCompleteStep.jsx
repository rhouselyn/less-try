    ...
    >
      {hasWrongItems && onSkipReview && (
        <motion.button
          ...
          className="absolute -top-2 left-0 z-10 flex items-center gap-1.5 btn-ghost text-xs border-[3px] border-[#1a1a2e] hover:border-[#1a1a2e] backdrop-blur-sm"
        >
          <X className="w-3 h-3" />
          {t.skipReview || '不想复习了'}
        </motion.button>
      )}
      <div className="bg-white border-[3px] border-[#1a1a2e] p-12 shadow-[3px_3px_0_#1a1a2e] text-center">
        <motion.div
          initial={{ scale: 0 }}
          animate={{ scale: 1 }}
          transition={{ type: 'spring', stiffness: 300, damping: 15, delay: 0.2 }}
          className="w-24 h-24 bg-[#fff0f6] border-[3px] border-[#1a1a2e] flex items-center justify-center mx-auto mb-8"
        >
          <Trophy className="w-12 h-12 text-[#ff006e]" />
        </motion.div>
        ...
        <motion.p
          ...
          className="text-lg text-[#4a4a6a] mb-2"
        >
        ...
        <motion.p
          ...
          className="text-base text-[#4a4a6a] mb-8"
        >
          {errorCount === 0
        ...
        {hasWrongItems && (
          <motion.div
            ...
            className="mb-8 p-4 bg-[#fff0f6] border-[3px] border-[#ff006e]"
          >
            <div className="flex items-center gap-2 justify-center mb-2">
              <RotateCcw className="w-4 h-4 text-[#ff006e]" />
              <span className="text-[#1a1a2e] font-bold">{t.wrongItemReview || '错题复习'}</span>
            </div>
