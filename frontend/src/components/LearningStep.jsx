    ...
    return (
      ...
      >
        <div className="text-center py-16">
          ...
          <p className="text-lg text-[#1a1a2e] font-semibold">{t.loading}</p>
        </div>
      </motion.div>
    )
  }
    ...
    >
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex items-center gap-3">
          {totalItemsInUnit > 0 && (
            <span className="text-sm text-[#2d2d4a] font-semibold font-cel">
      ...
      <AnimatePresence mode="wait">
        {!showWordCard ? (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: -20 }}
            className="bg-white border-[3px] border-[#1a1a2e] rounded-2xl p-8 shadow-cel-sm"
          >
            <div className="text-center mb-8">
              <div className="flex items-center justify-center gap-3 mb-2">
                ...
                <motion.button
                  ...
                  className="p-2 text-[#e63946] hover:text-[#e63946] hover:bg-[#e63946]/10 rounded-full transition-colors"
                />
              </div>
              {learningData.ipa && (
                <motion.p
                  ...
                  className="text-xl text-[#4a4a6a] ipa-font"
                >
            ...
            <div className="grid grid-cols-2 gap-3">
              {learningData.options.map((option, index) => (
                <motion.button
                  ...
                  className={`w-full py-3 px-4 text-left rounded-xl transition-all border-[3px] ${selectedOption === index ? (isCorrect ? 'bg-[#e6f5f3] border-[#2d9f8f] text-[#1a6b5a]' : 'bg-[#fde8e8] border-[#e63946] text-[#c1121f]') : 'border-[#1a1a2e] bg-white text-[#1a1a2e] hover:border-[#e63946]'}`}
                >
                  <div className="flex items-center gap-3">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                <h3 className="text-sm font-bold uppercase text-[#4a4a6a] tracking-wider mb-3 flex items-center gap-2 font-cel">
                ...
                >
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <motion.button
                      ...
                      className="p-1.5 text-[#e63946] hover:text-[#e63946] hover:bg-[#e63946]/10 rounded-full transition-colors shrink-0 mt-1"
                    >
                      ...
                      <div key={index} className="border-l-4 border-[#1a1a2e] pl-4">
                        <div className="flex items-start gap-2">
                          ...
                          <motion.button
                            ...
                            className="p-1 text-[#e63946] hover:text-[#e63946] hover:bg-[#e63946]/10 rounded-full transition-colors shrink-0"
                          >
