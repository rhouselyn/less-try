...
function MaskedSentenceExerciseStep({ data, onNext, onBack, onComplete, loading, t, onOpenVocabList, maskVersion, totalMasks, exerciseIndexInUnit, totalExercisesInUnit, sentencePreview, sourceLang, onAnswer, reviewMode, reviewIndex, wrongItemsCount }) {
  ...
  return (
    ...
    >
      ...
      <div className="bg-cream-50 border-2 border-ochre-400 rounded-none p-8 shadow-warm-sm font-serif">
          ...
          <div className="p-4 border-2 border-dashed border-bone-300 rounded-none flex flex-wrap gap-2 bg-cream-50/50 relative">
            ...
            <div className="absolute inset-0 p-4 flex flex-wrap gap-2 items-start content-start">
              ...
              <motion.button
                ...
                className="ml-auto p-2 text-ochre-400 hover:text-ochre-500 hover:bg-ochre-50 rounded-none transition-colors"
