    ...
    >
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex items-center gap-3">
          {totalItemsInUnit > 0 && (
            <span className="text-sm text-[#2d2d4a] font-medium">{(t.stepProgress || '第 {0} / {1} 题').replace('{0}', stepInUnit).replace('{1}', totalItemsInUnit)}</span>
          )}
          {onOpenVocabList && (
            <motion.button
        ...
        <div className="text-center mb-8">
          ...
          <div className="flex items-center justify-center gap-2">
            ...
            <motion.button
              ...
              className="p-2 text-[#e63946] hover:text-[#e63946] hover:bg-[#fde8e8] rounded-full transition-colors"
            >
          ...
          <div className="p-4 border-[3px] border-dashed border-[#1a1a2e] rounded-xl flex flex-wrap gap-2 bg-[#f0e6d3]/50 relative">
            ...
            <div className="absolute inset-0 p-4 flex flex-wrap gap-2 items-start content-start">
              {selectedTokens.length === 0 && (
                <span className="italic text-[#4a4a6a] pointer-events-none">{t.selectTokensHint}</span>
              )}
