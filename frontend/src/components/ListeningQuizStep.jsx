        ...
        <div className="text-center mb-8">
          ...
          <div className="flex items-center justify-center gap-3">
            <motion.button
              ...
              className="p-3 text-cadmium-600 hover:text-cadmium-600 hover:bg-cadmium-100 rounded-full transition-colors"
            >
          ...
          <div className="p-4 border-2 border-dashed border-cadmium-400 rounded-xl flex flex-wrap gap-2 bg-cadmium-50/50 relative">
            ...
            <div className="absolute inset-0 p-4 flex flex-wrap gap-2 items-center">
              {selectedWords.length === 0 && (
                <span className="italic text-umber-500 text-sm pointer-events-none">{t.tapToBuildSentence || '按顺序点击下方单词组成句子'}</span>
              )}
        ...
        {isChecked && (
          ...
          >
            <div className="flex items-center gap-3 mb-2">
              ...
              <span className={`font-semibold text-lg ${isCorrect ? 'text-teal-800' : 'text-vermilion-800'}`}>
