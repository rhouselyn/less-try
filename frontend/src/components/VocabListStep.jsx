  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-lg text-stone-600">{vocab.length} 个单词</p>
      </div>
          ...
          <div className="space-y-4">
            {vocab.map((word, index) => (
              <motion.div
                ...
                className="p-4 border-b border-stone-100 last:border-b-0"
              >
                <div className="flex items-center justify-between mb-2">
                  <h3 className="text-xl font-semibold text-stone-800">{word.word}</h3>
                  {word.ipa && (
                    <span className="text-sm text-stone-500">/{word.ipa}/</span>
                  )}
                </div>
                ...
                {word.morphology && (
                  <div className="mt-2">
                    <span className="inline-block px-2 py-1 bg-stone-100 text-stone-700 rounded text-xs font-medium">
                      {word.morphology}
                    </span>
                  </div>
                )}
