          ...
          if (clickable) {
            return (
              <span
                ...
                className="cursor-pointer rounded px-0.5 -mx-0.5 hover:bg-cadmium-200 hover:text-amber-800 transition-colors duration-150 border-b border-cadmium-400"
              >
                {part}
              </span>
            )
    ...
    >
      <div className="flex items-center gap-3 px-1">
        ...
        {editingTitle && (
          <input
            ...
            className="text-[13px] font-medium text-umber-600 bg-transparent border-b border-stone-300 px-1 py-0.5 max-w-[250px] focus:outline-none focus:border-cadmium-400 transition-colors"
          />
        )}
        ...
        {(preprocessStatus || (currentFileId && ((processingInfo && safeProcessingInfo.total > 0 && progress < 100) || (wordGenProgress && wordGenProgress.completed < wordGenProgress.total)))) && (
          <div className="flex items-center gap-2.5 shrink-0">
            {preprocessStatus ? (
              ...
              <div className="flex items-center gap-2">
                <span className="text-[10px] text-cadmium-500 tabular-nums whitespace-nowrap">
                ...
                <span className="text-[10px] text-cadmium-500 whitespace-nowrap">
      ...
      <div className="flex gap-6 flex-1 min-h-0" style={{ overflow: 'hidden' }}>
        <div className="w-1/2 flex flex-col min-h-0" style={{ overflow: 'hidden' }}>
          <div className="bg-white/90 border border-stone-300 rounded-3xl shadow-impasto overflow-hidden flex flex-col flex-1 min-h-0">
            <div className="px-5 py-3.5 border-b border-stone-300 bg-cadmium-50">
          ...
          <div className="bg-white/90 border border-stone-300 rounded-3xl shadow-impasto overflow-hidden flex flex-col flex-1 min-h-0">
            ...
            <div className="flex-1 flex min-h-0">
              ...
              {showGlobalVocab ? (
                globalVocabLoading ? (
                  <div className="py-16 text-center">
                    <Loader2 className="w-8 h-8 mx-auto mb-3 animate-spin text-cadmium-400" />
