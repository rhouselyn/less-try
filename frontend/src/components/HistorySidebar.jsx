      ...
      <div className="flex h-full">
        <AnimatePresence>
          {expanded && (
            <motion.div
              ...
              className="h-full overflow-hidden flex flex-col bg-[#EDE5D8] border-r border-bone-200/60"
              style={{ minWidth: 0 }}
            >
        ...
        {!expanded && (
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="flex-shrink-0 flex flex-col items-center pt-4 pb-2 gap-1 bg-[#EDE5D8] border-r border-bone-200/60"
            style={{ width: 48 }}
          >
            <button
