          ...
          {phases.map((phase, index) => (
            ...
            >
              <button
                ...
                className="w-full p-6 border-[3px] border-[#1a1a2e] bg-white hover:border-[#e63946] hover:shadow-cel-sm rounded-2xl transition-all"
              >
                <h3 className="text-xl font-black uppercase font-display text-[#1a1a2e] mb-2">
                  {phase.phase_number === 1 ? t.phase1 : t.phase2}
                </h3>
                <p className="text-[#1a1a2e] mb-2">{phase.units_count} {t.unit}s</p>
