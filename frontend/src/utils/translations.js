...
export const translations = {
  zh: {
    ...
    rateLimitError: "API 请求频率超限，请稍后重试或降低 LLM 速率",
    insufficientBalance: "API 余额不足，请充值后重试",
    connectionError: "无法连接到 API 服务，请检查网络或 API 地址",
  ...
  en: {
    ...
    rateLimitError: "API rate limit exceeded. Please retry later or reduce LLM rate",
    insufficientBalance: "Insufficient API balance. Please top up and retry",
    connectionError: "Cannot connect to API service. Please check your network or API URL",
