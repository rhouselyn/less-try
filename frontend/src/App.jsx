...
function FrogLogo({ size = 40 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
      <ellipse cx="50" cy="58" rx="38" ry="32" fill="#a8a08a" />
      <ellipse cx="50" cy="55" rx="34" ry="28" fill="#ccc5b0" />
      <circle cx="34" cy="38" r="16" fill="#a8a08a" />
      <circle cx="66" cy="38" r="16" fill="#a8a08a" />
      <circle cx="34" cy="38" r="13" fill="#fff" />
      <circle cx="66" cy="38" r="13" fill="#fff" />
      <circle cx="36" cy="37" r="6" fill="#554f42" />
      <circle cx="68" cy="37" r="6" fill="#554f42" />
      <circle cx="38" cy="35" r="2" fill="#fff" />
      <circle cx="70" cy="35" r="2" fill="#fff" />
      <ellipse cx="50" cy="62" rx="18" ry="8" fill="#f2d07a" />
      <path d="M38 60 Q50 70 62 60" stroke="#554f42" strokeWidth="2" fill="none" strokeLinecap="round" />
    </svg>
  )
}
...
function App() {
  ...
  return (
    <div className="h-screen overflow-hidden bg-canvas-50 bg-canvas-grain">
                ...
                <>
                  ...
                  {translatingUI && (
                    <div className="absolute inset-0 bg-canvas-50/80 backdrop-blur-sm z-20 flex items-center justify-center">
                      <div className="flex items-center gap-3 bg-white/80 border border-stone-300 rounded-2xl px-6 py-4 shadow-impasto">
