              ...
              {wordListLang ? (
                ...
                <>
                  <motion.button
                    ...
                    className="absolute top-3 right-4 p-2 text-sepia-500 hover:text-sepia-800 hover:bg-paper-100 border-2 border-transparent hover:border-vintage-border-400 transition-all z-10"
                  >
                    <Settings className="w-5 h-5" />
                  </motion.button>
                  {translatingUI && (
                    <div className="absolute inset-0 bg-paper-50/85 z-20 flex items-center justify-center">
                      <div className="flex items-center gap-3 bg-paper-50 border-2 border-sepia-600 px-6 py-4 shadow-vintage">
